...
<header class="re-page-head">
    ...
    <div class="d-flex flex-wrap gap-2">
        <a class="btn btn-re" href="add.php"><i class="fa-solid fa-house me-1"></i> Novo Imóvel</a>
                ...
                <?php if ($customers): ?>
                    <?php foreach ($customers as $customer): ?>
                        <tr>
                            ...
                            <td>
                                <img src="../img/casaexemplo.png" alt="" style="width: 125px; height: 85px; object-fit: cover;">
                            </td>
                            <td class="fw-semibold"><?php echo $customer['city']; ?></td>
                    ...
                    <tr>
                        <td colspan="7">
                            <div class="re-empty">
                                ...
                                <a class="btn btn-re" href="add.php"><i class="fa-solid fa-house me-1"></i> Cadastrar imóvel</a>
                            </div>
                        </td>
                    </tr>
                <?php endif; ?>
