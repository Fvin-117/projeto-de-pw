...
<?php if (!empty($_SESSION['message'])): ?>
    <div id="alert-message" class="alert alert-<?php echo $_SESSION['type']; ?> alert-dismissible fade show" role="alert">
    ...
    <div class="re-fieldset">
        ...
        <div class="row g-3">
            <?php if (!empty($customer['image'])): ?>
                ...
                <img src="<?php echo BASEURL . 'uploads/' . htmlspecialchars($customer['image']); ?>" alt="Imagem do imóvel"
                    width="300">
